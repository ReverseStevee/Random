...
⠀⠀⠀⠀⠀⠀⣠⣴⣾⣿⣿⣿⣿⣿⣿⣶⣤⣄⠀⠀⠀⠀⠀⠀⠀⠀ ${bold}${hijau}OWNER TOOLS: Stevee${Reset}
⠀⠀⠀⠀⣠⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣶⣄⠀⠀⠀⠀⠀ ${bold}${biru_tua}USERNAME TOOLS: Stevee${Reset}
⠀⠀⣠⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣆⠉⠉⢉⣿⣿⣿⣷⣦⣄⡀⠀ ${bold}${biru}USER: Permanent${Reset}
...
${bold}${cyan}Owner Tools  : Stevee${Reset}`)
} catch (error) {
  console.log(`Oops Something Went Wrong`)
}
...
⠀⠀⠀⠀⠈⠻⡇⠀⠀⠈⠙⠿⣿                     \x1b[1;31m    \x1b[95m\x1b[47mCREDITS\x1b[0m
                                  \x1b[1;31m Owner   : [ Stevee \x1b[1;31m]
`)
} catch (error) {
  console.log(`Oops Something Went Wrong`)
    sigma()
...
⠀⠀⠀⠀⠈⠻⡇⠀⠀⠈⠙⠿⣿
====================================================================
Created And Coder Full By Stevee`
steven.question(
...
${creatorCredits}`);
 ...
 Contoh => Zeus-Tls https://website.com 443 60`);
    ...
    console.log(`Ai ZEUSNET-C2 Started
